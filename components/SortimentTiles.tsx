        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-5">
          {categories.map((category) => (
            <Link
              ...
              className="group flex flex-col justify-between gap-6 rounded-md border border-slate-100 bg-white p-5 hover:border-slate-300 transition-colors min-h-[120px]"
            >

  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        {/* Main image */}
        <div
          className="relative w-full aspect-[10/11] rounded-lg overflow-hidden mb-2 cursor-zoom-in"
        ...
        {images.length > 1 && (
          <div className="grid grid-cols-2 gap-2">
            {images.slice(1, 5).map((img, idx) => (
              <div
                key={idx}
                className="relative w-full aspect-[10/11] rounded-lg overflow-hidden cursor-zoom-in"
                style={{ background: "#EEEEEE" }}
